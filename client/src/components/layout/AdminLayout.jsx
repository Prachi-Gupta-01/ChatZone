...
const Sidebar =({w = "100%"})=>{
  ...
  return (
    <Stack width={w} direction={"column"} p={"3rem"} spacing={"3rem"}>
      <Typography variant='h5' textTransform={"uppercase"}>chatzone</Typography>
      ...
      <Stack spacing={"1rem"}>
{
  adminTabs.map((tab)=>(
    ...
    >
      <Stack direction={"row"} alignItems={"center"} spacing={"1rem"}>{tab.icon()}
...
<Link onClick={logouthandler}
    >
      <Stack direction={"row"} alignItems={"center"} spacing={"1rem"}><ExitToAppIcon/>
